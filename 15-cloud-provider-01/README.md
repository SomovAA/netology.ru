...
ПРОБЛЕМЫ
1) Нет возможности создавать шлюз, его в интерфейсе просто нету даже в пробном варианте.
Я даже ручками его создать не могу, а через terraform думаю тем более такого не будет.
2) Не понятно, как пустить трафик из VM с приватной сетью другим способом, какие есть и где почитать?
Мб не через шлюз, а через IP, но какой там прописывать? Перепробовал и внутренние и внешний.
---
